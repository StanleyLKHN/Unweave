...
const initialMessages: Message[] = [
  {
    id: 1,
    from: 'agent',
    text: 'Hi, welcome to Unweave. I\'m here to help you find the perfect zero-waste piece, answer questions about our process, or guide you through the virtual try-on.',
    time: now(),
  },
]
...
const quickReplies = [
  ...
  'Tell me about zero waste production',
          ...
          <div style={{
            ...
            {quickReplies.map(q => (
              <button key={q} onClick={() => send(q)} style={{
                ...
                onMouseEnter={e => (e.currentTarget.style.background = 'var(--color-oatmeal)')}
